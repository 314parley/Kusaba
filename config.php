...
if (!$cache_loaded) {
	...
	/* Extra features */
		...
		$cf['KU_HIDE']            = true; /* Whether or not to add the hide thread button to pages */
		...
		$cf['KU_POSTSPY']         = true; /* Whether or not to allow users to enable the Post Spy feature */
	...
	/* Misc config */
		...
		$cf['KU_RANDOMSEED']        = 'jf9ds8ur54jhr99r666afhfdjg'; /* Type a bunch of random letters/numbers here, any large amount (35+ characters) will do */
